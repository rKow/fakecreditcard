...
public class FakeCreditCardGenerator {
  ...
  public FakeCreditCardResult getNewFake(FakeCreditCardItem item) {
    FakeCreditCardNumberGenerator fakeCreditCardNumberGenerator = new FakeCreditCardNumberGenerator();
    String creditCardNumber = fakeCreditCardNumberGenerator.getNumber(CreditCardType.MASTER_CARD);
